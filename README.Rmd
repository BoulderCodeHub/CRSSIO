...
# CRSSIO
<!-- badges: start -->
*Stable version (v0.10.0):* [![R build status](https://github.com/BoulderCodeHub/CRSSIO/workflows/R-CMD-check/badge.svg)](https://github.com/BoulderCodeHub/CRSSIO/actions)
...
*Development version:*  [![R build status](https://github.com/rabutler-usbr/CRSSIO/workflows/R-CMD-check/badge.svg)](https://github.com/BoulderCodeHub/CRSSIO/actions)
[![Codecov test coverage](https://codecov.io/gh/BoulderCodeHub/CRSSIO/branch/dev/graph/badge.svg)](https://codecov.io/gh/rabutler-usbr/CRSSIO?branch=dev)
<!-- badges: end -->
...
`crssi` objects add additional required input into CRSS: the Sacramento year type index, St. Vrain natural flow, and a scenario number. 
